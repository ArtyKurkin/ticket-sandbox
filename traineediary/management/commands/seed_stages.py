...
STAGES = [
    ...
    ("Задания в ticket-sandbox", "sandbox-candidate", 5, 1, 2, 5, "#14B8A6", StageGroup.SANDBOX_CANDIDATE, True, False,),
    ("Перед выходом в тикеты", "before-tickets", 6, 1, 1, 4, "#F59E0B", StageGroup.TEACHBASE, True, False,),
